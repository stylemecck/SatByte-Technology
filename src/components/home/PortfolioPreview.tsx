...
export function PortfolioPreview() {
  ...
  return (
    <section className="px-4 py-32 sm:px-6 lg:px-8 bg-background relative border-t border-border">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 sm:mb-16">
          <SectionHeader
            ...
            className="mb-0 text-left text-foreground [&_h2]:text-foreground [&_p]:text-muted-foreground group-[&_p]:text-primary"
          />
          <Link to="/portfolio" className="hidden md:inline-flex items-center gap-2 text-[15px] font-bold text-primary hover:opacity-80 transition-opacity mb-2">
          ...
          {slides.map((project, i) => {
            ...
            return (
              <motion.div
                ...
                className={cn(
                  "group relative overflow-hidden rounded-[1.5rem] bg-card shadow-sm hover:shadow-lg border border-border transition-shadow",
              ...
              >
                ...
                <div className="absolute inset-0 z-20 flex flex-col justify-end p-6 sm:p-8">
                  <div className="translate-y-4 group-hover:translate-y-0 transition-transform duration-500 ease-[cubic-bezier(0.2,0.8,0.2,1)]">
                    <h3 className={cn(
                      "font-heading font-extrabold text-foreground mb-2 leading-tight tracking-tight shadow-background/50 drop-shadow-md", 
                    ...
                    <Link 
                      to="/portfolio" 
                      className="inline-flex items-center justify-center h-11 w-11 rounded-full bg-primary text-primary-foreground opacity-0 group-hover:opacity-100 transition-all duration-500 hover:scale-110 shadow-lg group-hover:translate-x-1"
                    >
        ...
        <div className="mt-10 md:hidden flex justify-center">
          <Link to="/portfolio" className="inline-flex items-center gap-2 text-[15px] font-bold text-primary border-b-[2.5px] border-primary/30 pb-1.5 hover:border-primary transition-colors">
